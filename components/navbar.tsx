    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-blue-500/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5" onClick={() => trackNavClick("Logo", "/")}>
            <Image
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a
              ...
              className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              onClick={() => trackNavClick("GitHub", "https://github.com/GACWR/openuba-model-hub")}
            >
          ...
          <button
            ...
            onClick={() => { trackMobileMenuToggle(open ? "close" : "open"); setOpen(!open); }}
          >
        ...
        <div className="px-4 pb-4 pt-2 space-y-2">
          {links.map((l) => (
            <Link
              key={l.href}
              href={l.href}
              onClick={() => { trackNavClick(l.label, l.href); setOpen(false); }}
